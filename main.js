...
const uilMoon = document.getElementById('uil-moon');
const uilSun = document.getElementById('uil-sun');
...
function showIcon() {
	...
	if (currentTheme === 'light') {
		uilMoon.classList.toggle('hide');
		uilSun.classList.toggle('hide');
	}
}
